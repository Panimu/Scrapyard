...
export const CHANGELOG: readonly ChangelogEntry[] = Object.freeze([
  ...
  },
  {
    ...
    notes: [
      'Anything caught in the blast now drags at closer to half speed than two thirds. It wears off just as quickly as before - the bite is deeper, not longer.',
    ],
  },
  {
    at: '2026-08-29T12:00Z',
    version: 'v414',
    title: 'THE CANNON REACHES FURTHER',
    notes: [
      'Its shell now flies three hundred units instead of two hundred and forty, and the ladder carries that to four hundred. It still declines the shots at the very edge of its reach - it always has - so the range it will actually commit to grew with it.',
    ],
  },
  {
  ...
  {
    at: '2026-08-29T11:05Z',
    version: 'v411',
    title: 'A COIN CAN BE WORTH ANYTHING UP TO ITS CEILING',
    notes: [
  ...
  {
    at: '2026-08-29T10:40Z',
    version: 'v410',
    title: 'THE HORDE ARRIVES A LITTLE MORE GRADUALLY',
    notes: [
      'Bodies feed onto the field slightly slower. Just as many turn up in the end - this changes the pace they arrive at, not how many you face.',
    ],
  },
  {
  ...
  },
  {
    ...
    notes: [
      'The ground it leaves does a tenth more damage. The gun throws five percent slower to pay for it, so there is a little less of that ground down at any one time.',
    ],
  },
  {
  ...
  },
  {
    ...
    notes: [
      'A fifth off its range, at every tier. It still hits harder than anything else that fires one shell at a time, and it still picks the toughest thing it can see — it just has to let that thing get closer first.',
    ],
  },
  {
  ...
  },
  {
    ...
    notes: [
      'The credits have been redrawn. They were flat blue circles with a round highlight on them — which is how you draw a bubble, not money — and next to the blue XP gems they read as more of the same. They are struck discs now: a raised rim, a stamped nut on the face, and a bit of thickness under it. And the biggest drop is no longer a sack of coins but a stack of bullion bars, so the top of the ladder reads as a different kind of prize rather than as more of the same.',
