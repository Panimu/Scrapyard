 ...
 *
 * WHY THIS IS A FUSE AND NOT A TIMER: the shell already carries a countdown, and "half a second
 * after launch, unless it hit something first" is exactly what a fuse means. `fireSpread` cuts the
