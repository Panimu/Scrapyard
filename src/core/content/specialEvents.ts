 ...
 * 15/9/30/7 and the shape has inverted - the swarm is now the LIKELIEST outcome of a draw at
 * 48%, where in the table above it was the rarest set-piece at 17%. The chest elite is no longer
 * "half the ring" either; at 7 against 9 it is most of it. Read the arithmetic above for
...
export const SPECIAL_EVENTS: readonly SpecialEventDef[] = Object.freeze([
  ...
  Object.freeze({ id: EVENT_RING_ATTACK as SpecialEventId, name: 'ring attack', weight: 9 }),
