// <auto-generated>
//   Emitted by tools/gen_changelog.ts from src/ui/changelog.ts.
//   Do not edit: add the entry THERE and run `npm run changelog`.
// </auto-generated>

namespace Scrapyard.Game;

/// <summary>What changed, newest first.</summary>
/// <remarks>
/// <para>
/// GENERATED FROM <c>src/ui/changelog.ts</c>, which is where entries are written - that is the
/// file the project's own rules tell anybody touching this repository to update, and a second
/// list that also had to be edited would be a second list that stops being edited.
/// </para>
/// <para>
/// TIMES ARE UTC AND ARE PRINTED AS UTC. They come from git, which records UTC, and they are
/// rendered verbatim rather than converted to the machine's zone: a changelog records when the
/// REPOSITORY changed, and converting would make two people comparing notes on one build read
/// different timestamps for the same entry.
/// </para>
/// </remarks>
public static class Changelog
{
    /// <summary>One entry: when, what it was called, and one line per thing that changed.</summary>
    ...
    public static readonly Entry[] All =
    {
        ...
        new("2026-08-29T12:00Z", "v414", "THE CANNON REACHES FURTHER",
            new[]
            {
        ...
        new("2026-08-28T20:12Z", "v404", "THE MACHINE GUN RELOADS SOONER",
            new[]
            {
        ...
        new("2026-08-28T19:54Z", "v403", "THE PHASE CANNON BURSTS WIDER",
            new[]
            {
        ...
        new("2026-08-28T19:54Z", "v403", "THE FLAK CANNON SPLITS ITS BURST",
            new[]
            {
        ...
        new("2026-08-28T05:30Z", "v402", "THE PHASE CANNON THROWS A BALL OF PLASMA",
            new[]
            {
        ...
        new("2026-08-28T05:30Z", "v402", "ANYTHING CAN SHOOT A SHEEP NOW",
            new[]
            {
        ...
        new("2026-08-28T05:30Z", "v402", "LOCKED TROPHIES SHOW WHAT THEY ARE",
            new[]
            {
        ...
        new("2026-08-28T05:30Z", "v402", "THE CHEST LETS YOU SKIP THE REELS",
            new[]
            {
        ...
        new("2026-08-28T05:30Z", "v402", "THE DESKTOP BUILD DRAWS ITS MECHS AND MONSTERS PROPERLY",
            new[]
            {
        ...
        new("2026-08-27T20:52Z", "v402", "THE PHASE CANNON AIMS WHILE IT RELOADS",
            new[]
            {
        ...
        new("2026-08-27T20:06Z", "v402", "THE PHASE CANNON'S BURST HOLDS THE CROWD",
            new[]
            {
        ...
        new("2026-08-26T18:54Z", "v388", "THE MORTAR HITS FOR LESS",
            new[]
            {
        ...
        new("2026-08-26T18:41Z", "", "THE MORTAR'S BLAST IS SMALLER",
            new[]
            {
        ...
        new("2026-08-26T18:41Z", "", "HEAVY ARTILLERY'S BLAST IS SMALLER",
            new[]
            {
        ...
        new("2026-08-22T08:50Z", "", "CONTROLLER SUPPORT",
            new[]
            {
        ...
        new("2026-08-22T08:50Z", "", "FIXED: THE MECH WALKING OFF ON ITS OWN AFTER ALT-TAB",
            new[]
            {
        ...
        new("2026-08-22T08:50Z", "", "THE GAME LOOKS LIKE A GAME ON A BIG SCREEN",
            new[]
            {
        ...
        new("2026-08-21T19:41Z", "", "THE HORDE EASES OFF LATE-RUN",
            new[]
            {
        ...
        new("2026-08-21T17:01Z", "", "FIXED: THE MECH SHADOW SPINNING WITH THE CHASSIS",
            new[]
            {
        ...
        new("2026-08-21T12:06Z", "", "MECH ART PASS",
            new[]
            {
        ...
        new("2026-08-21T10:59Z", "", "AUTO LEVEL STOPS WASTING THE REPAIR CARD",
            new[]
            {
        ...
        new("2026-08-21T10:52Z", "", "NEW PASSIVE: AMMO DRUMS",
            new[]
            {
        ...
        new("2026-08-21T10:31Z", "", "FLAK TAKES A CUT, BOTH MISSILE RACKS HIT A LITTLE HARDER",
            new[]
            {
        ...
        new("2026-08-21T09:07Z", "", "FOUR NEW THINGS IN THE WORKSHOP",
            new[]
            {
        ...
        new("2026-08-21T08:07Z", "", "MOUNTS TAKE TWO TRIPS, AND THE STICKER EARNS ITS KEEP",
            new[]
            {
        ...
        new("2026-08-21T07:49Z", "", "RANDOM, TRY AGAIN, AND A NUDGE TOWARDS THE WORKSHOP",
            new[]
            {
        ...
        new("2026-08-21T07:02Z", "", "COINS THAT LOOK LIKE COINS",
            new[]
            {
        ...
        new("2026-08-21T05:39Z", "", "NOWHERE TO HIDE IN THE CITY",
            new[]
            {
        ...
        new("2026-08-20T20:07Z", "", "DRONES ARE A DESTINATION, NOT A DOOR PRIZE",
            new[]
            {
        ...
        new("2026-08-20T19:39Z", "", "FERN IS EARNED NOW",
            new[]
            {
        ...
        new("2026-08-20T19:32Z", "", "LOOK WHO IS DRIVING",
            new[]
            {
        ...
        new("2026-08-20T17:03Z", "", "AUTO LEVEL STARTS OFF, EVERY TIME",
            new[]
            {
        ...
        new("2026-08-20T16:54Z", "", "NO MORE TWO-HEADED SHEEP",
            new[]
            {
        ...
        new("2026-08-20T16:32Z", "", "THE SHEEP HAVE LEFT THE CITY",
            new[]
            {
        ...
        new("2026-08-20T16:32Z", "", "LASERS STOP AT THE FENCE NOW",
            new[]
            {
        ...
        new("2026-08-20T15:20Z", "", "FENCES ARE NOT PINATAS",
            new[]
            {
        ...
        new("2026-08-20T15:20Z", "", "A WORKING SITE LOOKS WORKED",
            new[]
            {
        ...
        new("2026-08-20T14:59Z", "", "FENCES THAT MEET AT THE CORNERS",
            new[]
            {
        ...
        new("2026-08-20T14:27Z", "", "ROOMS WITH NO DOOR",
            new[]
            {
        ...
        new("2026-08-20T12:50Z", "", "CITY CHAOS, TIGHTENED UP",
            new[]
            {
        ...
        new("2026-08-20T11:50Z", "", "THE FLOCK STOPPED HAUNTING THE FIELD",
            new[]
            {
        ...
        new("2026-08-20T11:39Z", "", "CITY CHAOS",
            new[]
            {
        ...
        new("2026-08-20T11:39Z", "", "THE MACHINES THAT OWN THE STREETS",
            new[]
            {
        ...
        new("2026-08-19T12:31Z", "", "THE HYDRA LEAVES YOU ROOM",
            new[]
            {
        ...
        new("2026-08-19T12:20Z", "", "AUTO LEVEL GETS OUT OF THE WAY",
            new[]
            {
        ...
        new("2026-08-19T07:03Z", "", "THE SIEGE REMEMBERS WHERE YOU WERE",
            new[]
            {
        ...
        new("2026-08-19T06:54Z", "", "THE HORNET, SHARPENED",
            new[]
            {
        ...
        new("2026-08-19T06:44Z", "", "THE HORNET BREAKS EARLIER",
            new[]
            {
        ...
        new("2026-08-19T06:38Z", "", "NEW PASSIVE: SHAPED CHARGES",
            new[]
            {
        ...
        new("2026-08-19T06:38Z", "", "HEAVIER MOUNTS, FASTER WALLS",
            new[]
            {
        ...
        new("2026-08-19T06:30Z", "", "TIER 8: THE CANNON BECOMES THE TWIN MOUNT",
            new[]
            {
        ...
        new("2026-08-19T05:53Z", "", "TURRETS YOU CAN BELIEVE",
            new[]
            {
        ...
        new("2026-08-19T05:53Z", "", "LASERS FIRE FROM REAL HARDPOINTS",
            new[]
            {
        ...
        new("2026-08-17T20:01Z", "", "THE TURRET ONLY RECOILS FOR ITS OWN SHOTS",
            new[]
            {
        ...
        new("2026-08-17T18:51Z", "", "A SECOND MYSTERY BAR",
            new[]
            {
        ...
        new("2026-08-17T17:58Z", "", "A LOCKED ACHIEVEMENT WITH A PROGRESS BAR",
            new[]
            {
        ...
        new("2026-08-17T17:53Z", "", "WEAPON KILL UNLOCKS COUNT ACROSS RUNS",
            new[]
            {
        ...
        new("2026-08-17T17:38Z", "", "NEW WEAPON: THE PHASE CANNON",
            new[]
            {
        ...
        new("2026-08-17T17:38Z", "", "BRASS CAN NOW BE EARNED, AND CARRIES THE PHASE CANNON",
            new[]
            {
        ...
        new("2026-08-17T16:32Z", "", "INDIGO CAN NOW BE EARNED",
            new[]
            {
        ...
        new("2026-08-17T16:32Z", "", "NEW IN THE WORKSHOP: BURSTING CHARGES",
            new[]
            {
        ...
        new("2026-08-17T16:32Z", "", "A RETUNED WORKSHOP UPGRADE REFUNDS ITSELF",
            new[]
            {
        ...
        new("2026-08-17T16:14Z", "", "S SILHOUETTE NOW MATCHES ITS GUN\",\n    notes: [\n      \"Indigo opens with the Heavy Artillery but was drawn carrying a boxed missile rack - leftover art from before it was moved onto that weapon. It now carries the howitzer tube its gun actually is, on the picker",
            System.Array.Empty<string>()),
        new("2026-08-17T15:18Z", "", "THREE PASSIVE ICONS REDRAWN",
            new[]
            {
        ...
        new("2026-08-17T13:43Z", "", "NEW PASSIVE: RADIATOR BANK",
            new[]
            {
        ...
        new("2026-08-17T13:17Z", "", "HEAVY BODIES ARE 50% FASTER",
            new[]
            {
        ...
        new("2026-08-17T13:17Z", "", "THE GTM HORNET SPLITS SOONER",
            new[]
            {
        ...
        new("2026-08-17T12:50Z", "", "S BONUS NO LONGER REACHES DRONES\",\n    notes: [\n      \"Bone",
            System.Array.Empty<string>()),
        new("2026-08-17T12:42Z", "", "FEWER SHEEP",
            new[]
            {
        ...
        new("2026-08-17T11:45Z", "", "DRONES DO LESS DAMAGE PER ROUND",
            new[]
            {
        ...
        new("2026-08-17T10:53Z", "", "LASERS ARE STOPPED BY TREES NOW - AND CUT THEM DOWN",
            new[]
            {
        ...
        new("2026-08-17T10:41Z", "", "THERE ARE SHEEP IN THE MOSS",
            new[]
            {
        ...
        new("2026-08-17T10:16Z", "", "MOSSY MAYHEM HAS TO BE EARNED",
            new[]
            {
        ...
        new("2026-08-17T10:01Z", "", "THE GAME NOW TELLS YOU HOW TO WIN IT",
            new[]
            {
        ...
        new("2026-08-17T09:49Z", "", "BEING SAVED NOW STOPS THE GAME",
            new[]
            {
        ...
        new("2026-08-17T09:25Z", "", "THE HORNET COMES APART SOONER",
            new[]
            {
        ...
        new("2026-08-17T09:06Z", "", "DRONES LAUNCH FROM THE MECH",
            new[]
            {
        ...
        new("2026-08-17T09:06Z", "", "HEAVIES WALK FASTER",
            new[]
            {
        ...
        new("2026-08-17T08:47Z", "", "EIGHT BOSSES IS ALL THERE IS",
            new[]
            {
        ...
        new("2026-08-17T08:23Z", "", "TREES HAVE TO BE CUT DOWN NOW",
            new[]
            {
        ...
        new("2026-08-17T08:06Z", "", "THE TROPHY SHELF HAS PICTURES ON IT",
            new[]
            {
        ...
        new("2026-08-17T05:04Z", "", "THERE IS A SECOND ASCENSION",
            new[]
            {
        ...
        new("2026-08-17T04:45Z", "", "THE JELLY AND THE OOZE HEAVE ALONG",
            new[]
            {
        ...
        new("2026-08-17T04:04Z", "", "THE MOSS STOPS WALKING BACKWARDS",
            new[]
            {
        ...
        new("2026-08-17T03:32Z", "", "THE SCRAPOPEDIA REMEMBERS AGAIN",
            new[]
            {
        ...
        new("2026-08-17T03:29Z", "", "THE MOSS HAS A WOOD IN IT",
            new[]
            {
        ...
        new("2026-08-16T21:16Z", "", "THE TURRET STOPS FLINCHING AT YOUR DRONES",
            new[]
            {
        ...
        new("2026-08-16T21:12Z", "", "EVERY GUN HAS ITS OWN COLOUR NOW",
            new[]
            {
        ...
        new("2026-08-16T21:02Z", "", "THE CHEST SAYS WHERE IT LEAVES YOU",
            new[]
            {
        ...
        new("2026-08-16T19:46Z", "", "THE RIG COMES EARLY NOW",
            new[]
            {
        ...
        new("2026-08-16T19:37Z", "", "THE BAY WORKS FASTER",
            new[]
            {
        ...
        new("2026-08-16T17:09Z", "", "BIG THINGS TAKE LONGER STEPS",
            new[]
            {
        ...
        new("2026-08-16T16:54Z", "", "THE BOSS IS OUTLINED, NOT SMUDGED",
            new[]
            {
        ...
        new("2026-08-16T16:19Z", "", "THE SPORELINGS HAVE LEARNED TO WALK",
            new[]
            {
        ...
        new("2026-08-16T14:22Z", "", "THEY DO NOT ALL COME THE SAME WAY",
            new[]
            {
        ...
        new("2026-08-16T13:49Z", "", "THE WALL WALKS FASTER",
            new[]
            {
        ...
        new("2026-08-16T13:46Z", "", "THE HORDE KNOWS THE WAY",
            new[]
            {
        ...
        new("2026-08-16T12:57Z", "", "THE HORDE FINDS ITS WAY IN",
            new[]
            {
        ...
        new("2026-08-16T12:31Z", "", "WALLS NOW BEHAVE LIKE WALLS",
            new[]
            {
        ...
        new("2026-08-16T12:14Z", "", "MOSSY MAYHEM HAS WALLS NOW",
            new[]
            {
        ...
        new("2026-08-16T10:31Z", "", "PAUSE SHOWS THE WHOLE LOADOUT, AND REROLLS ARE FOR SALE",
            new[]
            {
        ...
        new("2026-08-16T10:21Z", "", "THE FIELD MANUAL HAS A BESTIARY",
            new[]
            {
        ...
        new("2026-08-16T10:05Z", "", "THE FIELD MANUAL SHOWS BOTH MAPS",
            new[]
            {
        ...
        new("2026-08-16T09:42Z", "", "MOSSY MAYHEM HAS ITS OWN CREATURES",
            new[]
            {
        ...
        new("2026-08-16T08:25Z", "", "MOSSY MAYHEM IS PLAYABLE, AND IT DOES NOT END",
            new[]
            {
        ...
        new("2026-08-16T00:23Z", "", "DRONES FLY AT A FIXED SPEED, AND THEY ACTUALLY CIRCLE NOW",
            new[]
            {
        ...
        new("2026-08-16T00:02Z", "", "MECH INSURANCE, AND A COUNT OF WHAT IS STILL COMING",
            new[]
            {
        ...
        new("2026-08-15T22:40Z", "", "THE WORKSHOP OPENS - CREDITS FINALLY BUY SOMETHING",
            new[]
            {
        ...
        new("2026-08-15T22:25Z", "", "AN ASCENSION YOU HAVE HELD GETS ITS OWN PAGE",
            new[]
            {
        ...
        new("2026-08-15T20:15Z", "", "THE YARD HAS GROUND NOW, AND THE GROUND HAS ROADS",
            new[]
            {
        ...
        new("2026-08-15T19:49Z", "", "FIELD REPAIR - a system that mends you on a clock",
            new[]
            {
        ...
        new("2026-08-15T19:38Z", "", "A die in the drums, and gems that actually arrive",
            new[]
            {
        ...
        new("2026-08-15T19:15Z", "", "The Cyber Chest calls out what you just hit",
            new[]
            {
        ...
        new("2026-08-15T19:02Z", "", "The missile chassis get their swinging barrel back",
            new[]
            {
        ...
        new("2026-08-15T17:48Z", "", "A dying drone goes off with a pop, not a bang",
            new[]
            {
        ...
        new("2026-08-15T17:40Z", "", "Drone build time settles at sixteen seconds",
            new[]
            {
        ...
        new("2026-08-15T17:26Z", "", "Feed Systems no longer shortens a drone's life",
            new[]
            {
        ...
        new("2026-08-15T16:58Z", "", "The drone bay builds twice as fast",
            new[]
            {
        ...
        new("2026-08-15T16:49Z", "", "The missile symbols are painted like the missiles",
            new[]
            {
        ...
        new("2026-08-15T16:44Z", "", "The Long Missiles symbol shows all three of them",
            new[]
            {
        ...
        new("2026-08-15T16:40Z", "", "The two missile racks look like two different weapons",
            new[]
            {
        ...
        new("2026-08-15T16:34Z", "", "Hit points come from one place now",
            new[]
            {
        ...
        new("2026-08-15T16:07Z", "", "Drones last twice as long and hit half as hard",
            new[]
            {
        ...
        new("2026-08-15T15:54Z", "", "More rings, and more chests to chase",
            new[]
            {
        ...
        new("2026-08-15T15:49Z", "", "THE SWARM is what the yard does now",
            new[]
            {
        ...
        new("2026-08-15T15:41Z", "", "Set-pieces happen more often",
            new[]
            {
        ...
        new("2026-08-15T15:34Z", "", "THE CHEST ELITE - one enemy in the yard is worth chasing",
            new[]
            {
        ...
        new("2026-08-15T15:23Z", "", "A Cyber Chest with nothing left to give now shows you that",
            new[]
            {
        ...
        new("2026-08-15T15:11Z", "", "Drones arrive sooner, shoot bullets, and have a face on the reels",
            new[]
            {
        ...
        new("2026-08-15T14:49Z", "", "Drones stay in your fight instead of wandering out of it",
            new[]
            {
        ...
        new("2026-08-15T14:37Z", "", "A drone carries half the ammunition, and flies half as fast again",
            new[]
            {
        ...
        new("2026-08-15T14:22Z", "", "Drones fly at half speed, and stay in the fight",
            new[]
            {
        ...
        new("2026-08-15T14:12Z", "", "Drones look like drones",
            new[]
            {
        ...
        new("2026-08-15T14:03Z", "", "DRONES - a weapon that builds things instead of firing them",
            new[]
            {
        ...
        new("2026-08-15T13:30Z", "", "Two lasers no longer burn the same body",
            new[]
            {
        ...
        new("2026-08-15T13:21Z", "", "The Chain Laser is the mechanic and nothing else",
            new[]
            {
        ...
        new("2026-08-15T13:21Z", "", "Two more silhouettes can be earned",
            new[]
            {
        ...
        new("2026-08-15T12:05Z", "", "A version number, three more chassis to earn, and a proper unlock notification",
            new[]
            {
        ...
        new("2026-08-15T11:54Z", "", "The update prompt waits for the title screen",
            new[]
            {
        ...
        new("2026-08-15T11:42Z", "", "Back in the Scrapopedia actually closes the entry",
            new[]
            {
        ...
        new("2026-08-15T11:37Z", "", "The bestiary is written by killing things",
            new[]
            {
        ...
        new("2026-08-15T11:29Z", "", "The Scrapopedia gets sections, an enemy manual and an achievement list",
            new[]
            {
        ...
        new("2026-08-15T11:16Z", "", "Unlock criteria are not published anywhere",
            new[]
            {
        ...
        new("2026-08-15T11:05Z", "", "Two of the silhouettes can be earned",
            new[]
            {
        ...
        new("2026-08-15T10:57Z", "", "A locked mech is a silhouette with a question mark",
            new[]
            {
        ...
        new("2026-08-15T10:31Z", "", "The roster is down to Slate while the unlocks are written",
            new[]
            {
        ...
        new("2026-08-15T10:19Z", "", "Achievements",
            new[]
            {
        ...
        new("2026-08-15T10:10Z", "", "A roster you earn, and a manual you fill in",
            new[]
            {
        ...
        new("2026-08-15T09:53Z", "", "The barrel shows the gun that is aiming, and the manual stops spoiling tier 8",
            new[]
            {
        ...
        new("2026-08-15T09:46Z", "", "The Scrapopedia gets the mechs, and a Back button that says Back",
            new[]
            {
        ...
        new("2026-08-15T09:30Z", "", "THE SCRAPOPEDIA - a field manual on the title screen",
            new[]
            {
        ...
        new("2026-08-15T09:04Z", "", "Cards say what they do, not by how much",
            new[]
            {
        ...
        new("2026-08-15T08:50Z", "", "A bigger swarm, and Heavies that stay where you left them",
            new[]
            {
        ...
        new("2026-08-15T08:35Z", "", "The chest stops celebrating its second reel",
            new[]
            {
        ...
        new("2026-08-15T08:02Z", "", "THE SWARM - forty runners crossing the yard",
            new[]
            {
        ...
        new("2026-08-15T07:51Z", "", "Special Events: the ring can come for you at any time now",
            new[]
            {
        ...
        new("2026-08-15T07:13Z", "", "Heavies walk faster and shrug off shells",
            new[]
            {
        ...
        new("2026-08-15T07:03Z", "", "The Cannon has to turn its turret now",
            new[]
            {
        ...
        new("2026-08-15T00:19Z", "", "A blast is strongest where it lands",
            new[]
            {
        ...
        new("2026-08-14T23:58Z", "", "Every laser runs 25% cooler",
            new[]
            {
        ...
        new("2026-08-14T23:28Z", "", "Cannon and Artillery rate tiers are percentages now",
            new[]
            {
        ...
        new("2026-08-14T23:22Z", "", "Artillery and the Cannon both slow down",
            new[]
            {
        ...
        new("2026-08-14T23:10Z", "", "Heavy Artillery drops two shells, not three",
            new[]
            {
        ...
        new("2026-08-14T23:07Z", "", "The Cannon reaches 5% less far",
            new[]
            {
        ...
        new("2026-08-14T22:13Z", "", "Feed Systems now shortens the reload",
            new[]
            {
        ...
        new("2026-08-14T21:43Z", "", "The whole Chain Laser is drawn, not just its far end",
            new[]
            {
        ...
        new("2026-08-14T21:19Z", "", "One reroll a run",
            new[]
            {
        ...
        new("2026-08-14T21:05Z", "", "A level-up always has something on it",
            new[]
            {
        ...
        new("2026-08-14T21:05Z", "", "The Chain Laser starts at the mech, and a tier 8 chest shows its reels",
            new[]
            {
        ...
        new("2026-08-14T19:55Z", "", "Laser icons wear their own beam colour",
            new[]
            {
        ...
        new("2026-08-14T19:43Z", "", "TIER 8: the Medium Laser becomes the Chain Laser",
            new[]
            {
        ...
        new("2026-08-14T18:01Z", "", "Fuel barrels survive anything you cannot see",
            new[]
            {
        ...
        new("2026-08-14T17:57Z", "", "The stick works after a chest, and the reels take their time",
            new[]
            {
        ...
        new("2026-08-14T17:45Z", "", "Heavies look like Heavies, and the ring lands closer",
            new[]
            {
        ...
        new("2026-08-14T17:14Z", "", "Everything in the yard moves a quarter slower",
            new[]
            {
        ...
        new("2026-08-14T16:44Z", "", "The siege: fifty Heavies close in at 6:00 and 12:00",
            new[]
            {
        ...
        new("2026-08-14T15:34Z", "", "Twice as many fuel barrels in the yard",
            new[]
            {
        ...
        new("2026-08-14T15:25Z", "", "The yard restocks its fuel barrels",
            new[]
            {
        ...
        new("2026-08-14T15:17Z", "", "Elites and bosses keep the health, give back the damage",
            new[]
            {
        ...
        new("2026-08-14T15:07Z", "", "The Scrapyard is won at sixteen minutes with the yard clear",
            new[]
            {
        ...
        new("2026-08-14T15:00Z", "", "Twice the horde, and the big things hit like it",
            new[]
            {
        ...
        new("2026-08-14T14:46Z", "", "The game has a front door, and a name on it",
            new[]
            {
        ...
        new("2026-08-14T14:11Z", "", "Percentages add up instead of multiplying together",
            new[]
            {
        ...
        new("2026-08-14T13:55Z", "", "Ordnance makes lasers run hot",
            new[]
            {
        ...
        new("2026-08-14T12:39Z", "", "The chest reels actually spin now",
            new[]
            {
        ...
        new("2026-08-14T12:39Z", "", "The slot machine tells you where you stand while it is still spinning",
            new[]
            {
        ...
        new("2026-08-14T12:11Z", "", "Enemies never stop dropping XP",
            new[]
            {
        ...
        new("2026-08-14T11:44Z", "", "Chest reels show your own loadout, and pay out in it",
            new[]
            {
        ...
        new("2026-08-14T11:16Z", "", "Bosses drop a Cyber Chest",
            new[]
            {
        ...
        new("2026-08-14T10:28Z", "", "Credits are kept between runs",
            new[]
            {
        ...
        new("2026-08-14T10:28Z", "", "There is land beyond the fence again",
            new[]
            {
        ...
        new("2026-08-14T10:28Z", "", "Fuel barrels: smaller, everywhere, and sometimes empty",
            new[]
            {
        ...
        new("2026-08-14T09:44Z", "", "Walk into a barrel and it goes over",
            new[]
            {
        ...
        new("2026-08-14T09:13Z", "", "Fuel barrels, and the three things inside them",
            new[]
            {
        ...
        new("2026-08-14T08:48Z", "", "Wrecked hulls in the yard",
            new[]
            {
        ...
        new("2026-08-14T08:41Z", "", "Scrap in the yard, and an endgame that is heavy rather than fast",
            new[]
            {
        ...
        new("2026-08-14T07:56Z", "", "The arena is a fenced scrapyard, not a loop",
            new[]
            {
        ...
        new("2026-08-14T00:05Z", "", "The arena wraps, and nothing despawns",
            new[]
            {
        ...
        new("2026-08-13T23:30Z", "", "The summary says which weapon was carrying the run",
            new[]
            {
        ...
        new("2026-08-13T23:05Z", "", "Every weapon shows what it is waiting on",
            new[]
            {
        ...
        new("2026-08-13T22:45Z", "", "The Machine Gun shows its magazine and its reload",
            new[]
            {
        ...
        new("2026-08-13T22:15Z", "", "Plum starts with the shield and nothing else",
            new[]
            {
        ...
        new("2026-08-13T22:10Z", "", "Missiles steer, lasers reach further",
            new[]
            {
        ...
        new("2026-08-13T21:55Z", "", "Upgrade cards say which pool at a glance",
            new[]
            {
        ...
        new("2026-08-13T20:50Z", "", "Mechs stop being skins",
            new[]
            {
        ...
        new("2026-08-13T20:35Z", "", "Artillery aims, and the two missile racks look different",
            new[]
            {
        ...
        new("2026-08-13T20:20Z", "", "Onyx takes the Long Missiles",
            new[]
            {
        ...
        new("2026-08-13T20:05Z", "", "New passive: Energy Shield",
            new[]
            {
        ...
        new("2026-08-13T18:55Z", "", "Only Heavy Artillery has a blast radius",
            new[]
            {
        ...
        new("2026-08-13T18:09Z", "", "Lasers burn through instead of holding fire",
            new[]
            {
        ...
        new("2026-08-13T17:49Z", "", "Health bars mean rank",
            new[]
            {
        ...
        new("2026-08-13T17:37Z", "", "Level-ups heal",
            new[]
            {
        ...
        new("2026-08-13T17:23Z", "", "Enemies slowed by 12%",
            new[]
            {
                "Every cycle in the enemy ladder moves one step slower. Ranks are unchanged, so elites and bosses stay slower still.",
            }),
        new("2026-08-13T17:22Z", "", "The mechs walk",
            new[]
            {
        ...
        new("2026-08-13T16:40Z", "", "Sixteen mechs",
            new[]
            {
        ...
        new("2026-08-13T13:44Z", "", "New player art, and the hero previews come back",
            new[]
            {
        ...
        new("2026-08-13T13:27Z", "", "The 120-second enemy cycle",
            new[]
            {
        ...
        new("2026-08-13T12:43Z", "", "Five weapons, five passives",
            new[]
            {
        ...
        new("2026-08-13T11:20Z", "", "Machine Gun",
            new[]
            {
        ...
        new("2026-08-13T11:07Z", "", "Two missile racks",
            new[]
            {
        ...
        new("2026-08-13T09:57Z", "", "Every hero opens with a different weapon",
            new[]
            {
                "Your starting gun is the reason to pick a chassis, and it starts at tier 1 of its own ladder.",
            }),
        new("2026-08-13T09:55Z", "", "Enemies slowed",
            new[]
            {
                "Every enemy is about a fifth slower, so the horde closes at a pace you can read.",
            }),
        new("2026-08-13T09:53Z", "", "Seven-tier weapon ladders",
            new[]
            {
        ...
        new("2026-08-13T09:07Z", "", "The three lasers",
            new[]
            {
        ...
        new("2026-08-13T08:28Z", "", "Loading fixed",
            new[]
            {
        ...
        new("2026-08-13T08:19Z", "", "The Cannon's targeting rule earns its keep",
            new[]
            {
        ...
        new("2026-08-12T22:28Z", "", "First playable",
            new[]
            {
        ...
        new("2026-08-12T16:26Z", "", "Project started",
            new[]
            {
                "Scrapyard begins.",
            }),
    ...
    /// <summary>
    /// <c>2026-08-13T18:55Z</c> becomes <c>13 Aug 2026 - 18:55 UTC</c>.
    /// </summary>
    /// <remarks>
    /// PARSED BY HAND rather than through <c>DateTime</c>: the string is already the exact
    /// instant to show, and routing it through a date type only creates opportunities to shift
    /// it by a timezone. A malformed stamp renders as itself rather than as an error.
    /// </remarks>
    public static string FormatTime(string at)
    {
        if (at.Length != 17 || at[4] != '-' || at[7] != '-' || at[10] != 'T'
            || at[13] != ':' || at[16] != 'Z') return at;

        if (!int.TryParse(at.AsSpan(5, 2), out int m) || m < 1 || m > 12) return at;
        if (!int.TryParse(at.AsSpan(8, 2), out int d)) return at;
        return $"{d} {Months[m - 1]} {at[..4]} - {at.Substring(11, 5)} UTC";
    }
}
